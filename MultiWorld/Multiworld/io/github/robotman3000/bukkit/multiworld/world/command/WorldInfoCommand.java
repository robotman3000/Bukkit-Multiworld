...
public class WorldInfoCommand extends JavaPluginCommand {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if(world != null){
			if(sender.hasPermission("spigotplus.multiworld.command.info." + world.getName())){
				sender.sendMessage(WorldManagerHelper.asStringArray(world));
				return true;
			} else {
				sender.sendMessage(ChatColor.RED + "You aren't permitted to get info for that world");
			}
		} else {
